...
<head>
  ...
  <title>@yield('title','layout') | SGA</title>
  <!-- Bootstrap Core CSS -->
      ...
      <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
          <li style="padding: 70px 0 0;">
            <a href="{{ route('asistencias.create') }}" class="waves-effect"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Home</a>
          </li>
          <li>
            <a href="{{ route('estudiantes.create') }}" class="waves-effect"><i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i>Registrar</a>
          </li>
          <li>
            <a href="{{ route('estudiantes.index') }}" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Estudiantes</a>
          </li>
          <li>
            <a href="{{ route('tareas.index') }}" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Tareas</a>
          </li>
          <li>
